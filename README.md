...
* **Optimalisasi Kompresi Gambar (Client-Side Compression):** Mengimplementasikan auto-kompresi gambar dan panel kontrol kompresi manual berbasis canvas di sisi klien untuk menangani foto resolusi tinggi dari kamera handphone (hingga 4MB+) menjadi ukuran sangat hemat (60-120KB) guna mencegah limit payload server (Error 413) di Vercel.
* **Deployment:** Source code dikelola menggunakan Git dan didistribusikan secara online melalui platform GitHub dengan auto-deployment ke Vercel/Netlify.
